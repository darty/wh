...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean RecordHaptics
        {
            get
            {
                return SteamVR_Actions.default_RecordHaptics;
            }
        }
        ...
        public virtual SteamVR_Action_Boolean SwitchActuator
        {
            get
            {
                return SteamVR_Actions.default_SwitchActuator;
            }
        }
