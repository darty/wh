...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        protected virtual void FixedUpdate()
        {
            ...
            {
                Debug.LogWarning("FixedUpdate START currentAttachedObject.transform.position = " + currentAttachedObject.transform.position.x);
                ...
                Debug.LogWarning("FixedUpdate END currentAttachedObject.transform.position = " + currentAttachedObject.transform.position.x);
